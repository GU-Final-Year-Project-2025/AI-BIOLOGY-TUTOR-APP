    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(anatomy.this, menu.class); // Replace MenuActivity with your actual menu class
        ...
        testButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(anatomy.this, Quiz.class);
                startActivity(intent);
            }
        });
        ...
        btn_theory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(anatomy.this, AnatomyTheory.class);
                startActivity(intent);
            }
        });
        ...
        btn_textbooks.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent online = new Intent(anatomy.this, OnlineAnatomy.class );
        ...
        btn_practicals.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent online = new Intent(anatomy.this, AnatomyVideos.class );
                startActivity(online);
            }
        });
