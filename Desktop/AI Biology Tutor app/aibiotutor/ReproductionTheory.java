...
public class ReproductionTheory extends AppCompatActivity implements TextToSpeech.OnInitListener, OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupWindow();
        setContentView(R.layout.activity_reproduction_theory);
        setupToolbar();
    ...
    private void setupToolbar() {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Reproduction Theory");
        }
    ...
    private void copyPdfFromAssets() throws IOException {
        InputStream inputStream = getAssets().open("Reproduction.pdf");
    ...
    private void setupTtsListener() {
        textToSpeech.setOnUtteranceProgressListener(new UtteranceProgressListener() {
            ...
            public void onError(String utteranceId) {
                ...
                runOnUiThread(() -> {
                    isSpeaking = false;
                    Toast.makeText(ReproductionTheory.this, "Error speaking", Toast.LENGTH_SHORT).show();
                });
            }
        });
    }
