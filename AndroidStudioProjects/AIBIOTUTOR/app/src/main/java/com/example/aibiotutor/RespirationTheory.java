...
public class RespirationTheory extends AppCompatActivity implements TextToSpeech.OnInitListener, OnPageChangeListener {
    ...
    private void setupTtsListener() {
        textToSpeech.setOnUtteranceProgressListener(new UtteranceProgressListener() {
            ...
            public void onError(String utteranceId) {
                ...
                runOnUiThread(() -> {
                    isSpeaking = false;
                    Toast.makeText(RespirationTheory.this, "Error speaking", Toast.LENGTH_SHORT).show();
                });
            }
        });
    }
